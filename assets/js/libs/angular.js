...
(function(Z, Q, r) {
    ...
    function F(b) {
        return function() {
            var a = arguments[0],
                c, a = "[" + (b ? b + ":" : "") + a + "] http://errors.angularjs.org/1.2.7/" + (b ? b + "/" : "") + a;
            ...
            if (!d || null != b)
                for (; e.length;)
                    for (k = e.shift(),
                        ...
                        for (p = A(k[l]), m ? p.triggerHandler("$destroy") : m = !m, s = 0, p = (C = p.children()).length; s < p; s++) e.push(Ba(C[s]));
    ...
    function la(b, a, c) {
        var d =
            b[db],
            d = Qa[d || -1];
        if (B(c)) d || (b[db] = d = ++Xc, d = Qa[d] = {}), d[a] = c;
        else return d && d[a]
    }
    ...
    function dd(b, a, c, d) {
        ...
        h.cookies = function(a, b) {
            var d, e, g, h;
            if (a) b ===
                r ? m.cookie = escape(a) + "=;path=" + ba + ";expires=Thu, 01 Jan 1970 00:00:00 GMT" : D(b) && (d = (m.cookie = escape(a) + "=" + escape(b) + ";path=" + ba).length + 1, 4096 < d && c.warn("Cookie '" + a + "' possibly not set or overflowed because it was too large (" + d + " > 4096 bytes)!"));
            else {
                if (m.cookie !== J)
                ...
                function J(a, b, c, d, f) {
                    ...
                    switch (a.nodeType) {
                        case 1:
                            ...
                            a = a.className;
                            if (D(a) && "" !== a)
                                for (; m = g.exec(a);) n = ma(m[2]), T(b, n, "C", d, f) && (c[n] = aa(m[3])), a = a.substr(m.index + m[0].length);
                            break;
                        case 3:
                            F(b, a.nodeValue);
                            break;
                ...
                function ia(a, c, d, e, g, f, m, n, p) {
                    ...
                    for (var T = !1, z = !1, t = d.$$element = A(c), G, ca, U, F = e, O, M = 0, na = a.length; M < na; M++) {
                        ...
                        if (U = G.transclude) T = !0, G.$$tlb || (x("transclusion", p, G, t), p = G), "element" == U ? (z = !0, N = G.priority, U = ba(c, Ua, S),
                            t = d.$$element = A(Q.createComment(" " + ca + ": " + d[ca] + " ")), c = t[0], hb(g, A(va.call(U, 0)), c), F = v(U, e, N, f && f.name, {
                                nonTlbTranscludeDirective: p
                            })) : (U = A(zb(c)).contents(), t.empty(), F = v(U, e));
                        if (G.template)
        ...
        this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector",
            function(a, b, c, d, n, p) {
                ...
                function C(b,
                    ...
                    function k() {
                        var a = ab(s.pendingRequests, b); - 1 !== a && s.pendingRequests.splice(a, 1)
                    }
                    var p = n.defer(),
                        C = p.promise,
        ...
        this.$get = ["$injector", "$exceptionHandler",
            ...
            function(d, e, g, f) {
                ...
                h.prototype = {
                    constructor: h,
                    $new: function(a) {
                        a ? (a = new h, a.$root = this.$root, a.$$asyncQueue = this.$$asyncQueue, a.$$postDigestQueue = this.$$postDigestQueue) : (a = function() {}, a.prototype = this, a = new a, a.$id = Ya());
                        a["this"] = a;
                        a.$$listeners = {};
                        a.$$listenerCount = {};
                        a.$parent = this;
                            ...
                            a: do {
                                if (h = N.$$watchers)
                                    for (q = h.length; q--;) try {
                                        if (d = h[q])
                                            if ((f = d.get(N)) !== (g = d.last) && !(d.eq ? ua(f, g) : "number" == typeof f && "number" == typeof g && isNaN(f) && isNaN(g))) v = !0, c = d, d.last = d.eq ? fa(f) : f, d.fn(f, g === n ? f : g, N), 5 > r && (J = 4 - r, V[J] || (V[J] = []), A = L(d.exp) ? "fn: " + (d.exp.name || d.exp.toString()) : d.exp, A += "; newVal: " + pa(f) + "; oldVal: " + pa(g), V[J].push(A));
                                            else
                                        if (d === c) {
                                            v = !1;
                                            break a
    ...
    function Bd() {
        ...
        this.$get = function() {
            return function(c, d) {
                ...
                if (!M || 8 <=
                    M)
                    if (g = qa(c).href, "" !== g && !g.match(e)) return "unsafe:" + g;
                return c
            }
        }
    }
                    ...
                    getTrusted: function(c, d) {
                        ...
                        if (c === ea.RESOURCE_URL) {
                            ...
                            for (n = b.length; l < n; l++)
                                if ("self" === b[l] ? Fb(g) : b[l].exec(g.href)) {
                                    p = !0;
                                    break
                                }
                            if (p)
                                for (l = 0, n = a.length; l < n; l++)
                                    if ("self" === a[l] ? Fb(g) : a[l].exec(g.href)) {
                                        p = !1;
                                        break
                                    }
                            if (p) return d;
    ...
    function Fc(b, a, c, d, e) {
        ...
        if (k) 0 < e && (-1 < b && 1 > b) && (h = b.toFixed(e));
            ...
            var l = 0,
                ...
                p = a.gSize;
            if (f.length >= n + p)
                for (l = f.length - n, k = 0; k < l; k++) 0 === (l - k) % p && 0 !==
                    k && (h += c), h += f.charAt(k);
    ...
    var Tc = /[A-Z]/g,
        ...
        Xc = 1,
        Ic = Z.document.addEventListener ? function(b, a, c) {
        ...
        search: function(a, c) {
            switch (arguments.length) {
                case 0:
                    return this.$$search;
                case 1:
                    if (D(a)) this.$$search = Wb(a);
                    else if (X(a)) this.$$search =
                        a;
    ...
    var Jc = function(a) {
        ...
        $d = /^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,6}$/,
        ae =
            /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/,
        Kc = {
            text: pb,
        ...
        Ha = "ng-pristine",
        ob = "ng-dirty",
        be = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse",
            function(a, c, d, e, g) {
                function f(a, c) {
                    c = c ? "-" + cb(c, "-") : "";
                    ...
                    link: function(e, f, h, m) {
                        ...
                        function n(e, f, g) {
                            function h() {
                                ...
                                if (s)
                                    if (w && K(t))
                                        for (r = new Ra([]), z = 0; z < t.length; z++) I[l] = t[z], r.put(w(e, I), t[z]);
                                    else r = new Ra(t);
                                ...
                                e.$apply(function() {
                                    ...
                                    if (s)
                                        for (k = [], p = 0, u = x.length; p < u; p++)
                                            for (a = x[p], m = 1, t = a.length; m < t; m++) {
                                                if ((h = a[m].element)[0].selected) {
                                                    h = h.val();
                                                    n && (d[n] = h);
                                                    if (w)
                                                        for (v = 0; v < c.length && (d[l] = c[v], w(e, d) != h); v++);
                                                    else d[l] = c[h];
                                                    k.push(q(e, d))
                                                }
